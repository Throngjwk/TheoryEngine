...
var init = () => {
    ...
    theory.createAutoBuyerUpgrade(2, currency, 1e9);
    ...
    ///////////////////
    //// Story chapters
    chapter1 = theory.createStoryChapter(0, "Changelog", "v1.0.0: Intial Release!", () => c1.level > -1);
    chapter2 = theory.createStoryChapter(1, "Engine Changelog", "v0.0.1: Private Bulids. \nv0.1.0: First Pubic Bulid.", () => c1.level > -1);
    chapter3 = theory.createStoryChapter(2, "My First Chapter", "This is line 1,\nand this is line 2.\n\nNice.", () => c1.level > 0);
    chapter4 = theory.createStoryChapter(3, "My Second Chapter", "This is line 1 again,\nand this is line 2... again.\n\nNice again.", () => c2.level > 0);
...
var getPublicationMultiplier = (tau) => tau.pow(0.366);
