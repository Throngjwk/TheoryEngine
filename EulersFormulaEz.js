...
var init = () => {
    ...
    // t
    {
        let getDesc = (level) => "\\dot{t}=" + BigNumber.from(0.2 + (0.2 * level)).toString(level > 99 ? 0 : 1);
        let getInfo = (level) => "\\dot{t}=" + BigNumber.from(0.2 + (0.2 * level)).toString(level > 99 ? 0 : 1);
    ...
    // q2
    {
        ...
        q2 = theory.createUpgrade(2, currency, new ExponentialCost(5, Math.log2(2)));
    ...
    // c3
    {
        let getDesc = (level) => "c_3=" + (1.1 + (0.0125 * c_base.level)) + "^{" + level + "}";
        let getInfo = (level) => "c_3=" + getC3(level).toString(2);
        c3 = theory.createUpgrade(7, currency_I, new ExponentialCost(200, Math.log2(2)));
    ...
    // a1
    {
        ...
        a1 = theory.createUpgrade(8, currency, new FirstFreeCost(new ExponentialCost(2000, 2.2)));
    ...
    // a2
    {
        ...
        a2 = theory.createUpgrade(9, currency_R, new ExponentialCost(500, 2.2));
    ...
    // a3
    {
        ...
        a3 = theory.createUpgrade(10, currency_I, new ExponentialCost(500, 2));
    ...
    // a4
    {
        let getDesc = (level) => "a_4=2^{" + level + "}";
        let getInfo = (level) => "a_4=" + getQ2(level).toString(0);
        a4 = theory.createUpgrade(11, currency_I, new ExponentialCost(1e120, 10));
        a4.getDescription = (_) => Utils.getMath(getDesc(a3.level));
        a4.getInfo = (amount) => Utils.getMathTo(getInfo(a3.level), getInfo(a3.level + amount));
        a4.bought = (sVarBought);
    }
    ...
    let achievement_category_5 = theory.createAchievementCategory(4, "Imagiary");
    let achievement_category_6 = theory.createAchievementCategory(5, "睷");

    let e6 = BigNumber.from(1e6);
    ...
    theory.createAchievement(9, achievement_category_1, "You Win!?!?!?!?!?!?", "Reach ∞τ.", () => theory.tau > e308);

    theory.createAchievement(10, achievement_category_2, "Automatic Analysis", "Let your machine learning algorithm calculate the theory for you.", () => theory.isAutoBuyerAvailable);
    theory.createAchievement(11, achievement_category_2, "Realistic Methods", "Figure out how to use R (real dimension).", () => dimension.level > 0);
    theory.createAchievement(12, achievement_category_2, "Imaginary Concepts", "Figure out how to use I (imaginary dimension).", () => dimension.level > 1);
    theory.createAchievement(13, achievement_category_2, "Arithmetic Multiplication", "Use the idea of your colleagues and add a multiplier.", () => a_base.level > 0);
    theory.createAchievement(14, achievement_category_2, "Exponential Growth", "Add an exponent to your main equation.", () => a_exp.level > 0);
    theory.createAchievement(15, achievement_category_2, "Acids and ...Bases?", "Change the base of b2.", () => b_base.level > 0);

    theory.createAchievement(16, achievement_category_3, "First Time", "Publish your research once.", () => num_publications >= 1);
    theory.createAchievement(17, achievement_category_3, "Not a fad?", "Publish your research twice.", () => num_publications >= 2);
    theory.createAchievement(18, achievement_category_3, "I recognize this name!", "Publish your research 5 times.", () => num_publications >= 5);
    theory.createAchievement(19, achievement_category_3, "Famous Publicist", "Publish your research 10 times.", () => num_publications >= 10);
    theory.createAchievement(21, achievement_category_3, "Senior Writer", "Publish your research 25 times.", () => num_publications >= 25);
    theory.createAchievement(22, achievement_category_3, "Lead Author", "Publish your research 50 times.", () => num_publications >= 50);
    theory.createAchievement(23, achievement_category_3, "Lol", "Publish your research 66 times.", () => num_publications >= 66);

    theory.createAchievement(24, achievement_category_5, "1 Million Imagiary", "Reach 1e6I.", () =>  currency_I.value > e6);
    theory.createAchievement(25, achievement_category_5, "Double Quintuple Digits Imagiary", "Reach 1e10I.", () =>  currency_I.value > e10);
    theory.createAchievement(26, achievement_category_5, "... dot since floor imaginary ...", "Reach 1e25I.", () =>  currency_I.value > e25);
    theory.createAchievement(27, achievement_category_5, "Lcillion", "Reach 1e50I.", () =>  currency_I.value > e50);
    theory.createAchievement(28, achievement_category_5, "The Endgame", "Reach 1e93I.", () =>  currency_I.value > e93);
    
    theory.createAchievement(29, achievement_category_6, "Go to Avaiable Upgrade!?!?!?!?", "Reach 1e93I.", () =>  a4.level > 0);
...
var getA4 = (level) => BigNumber.TWO.pow(level);
...
var getC3 = (level) => BigNumber.from(1.1 + (0.0125 * c_base.level)).pow(level);
var getC4 = (level) => BigNumber.from(1.1 + (0.0125 * c_base.level)).pow(level);
